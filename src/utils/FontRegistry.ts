...
export class FontRegistry {
   ...
   */
  private static readonly BOLD_PATTERNS: RegExp[] = [
    /bold/i,
    /demibold/i,
    /semi[- ]?bold/i,
    /extrabold/i,
   ...
   */
  private static readonly ITALIC_PATTERNS: RegExp[] = [
    /italic/i,
    /oblique/i,
    /slanted/i,
    /inclined/i,
   ...
   */
  private static readonly FONT_FAMILIES: Map<
    string,
   ...
   */
  private static detectWeight(fontName: string): FontWeight {
   ...
   */
  private static detectStyle(fontName: string): FontStyle {
    const lower = fontName.toLowerCase();
   ...
   */
  private static isBold(_fontName: string, weight: FontWeight): boolean {
   ...
   */
  private static isItalic(_fontName: string, style: FontStyle): boolean {
   ...
   */
  private static extractFamilyName(fontName: string): string {
   ...
   */
  private static extractVariantName(fontName: string): string {
