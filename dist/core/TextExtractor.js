...
const FontRegistry_1 = require("../utils/FontRegistry");
/**
...
class TextExtractor {
    ...
    extractTextElements(operations) {
        ...
        let currentMatrix = { ...ContentStreamParser_1.IDENTITY_MATRIX };
    ...
    createTextElement(text, x, y, width, fontSize, fontName) {
        ...
        const characteristics = FontRegistry_1.FontRegistry.analyze(fontName);
