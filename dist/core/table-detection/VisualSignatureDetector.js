...
exports.VisualSignatureDetector = exports.DEFAULT_VISUAL_SIGNATURE_CONFIG = void 0;
/** Default visual signature configuration. */
exports.DEFAULT_VISUAL_SIGNATURE_CONFIG = {
    gridWidth: 50,
    gridHeight: 70,
    matchThreshold: 0.6,
    templates: [],
...
class VisualSignatureDetector {
    constructor(config) {
        this.config = { ...exports.DEFAULT_VISUAL_SIGNATURE_CONFIG, ...config };
    }
    getName() {
...
exports.VisualSignatureDetector = VisualSignatureDetector;
//# sourceMappingURL=VisualSignatureDetector.js.map