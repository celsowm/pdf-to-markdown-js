...
exports.TableTransformer = void 0;
const MarkdownNode_1 = require("../models/MarkdownNode");
const table_detection_1 = require("../core/table-detection");
/**
...
class TableTransformer {
    constructor(config = {}) {
        ...
        this.registry = (0, table_detection_1.createStandardRegistry)(config.registry);
    }
    getPriority() {
    ...
    transform(elements, _allElements) {
        const config = {
            ...table_detection_1.DEFAULT_DETECTION_CONFIG,
            tolerance: this.config.tolerance ?? table_detection_1.DEFAULT_DETECTION_CONFIG.tolerance,
        };
    ...
    buildMarkdownTable(table, elements) {
        ...
        return (0, MarkdownNode_1.createTableNode)(finalHeaders, rows);
    }
    /**
...
//# sourceMappingURL=TableTransformer.js.map