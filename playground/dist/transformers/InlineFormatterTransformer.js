...
exports.InlineFormatterTransformer = void 0;
...
class InlineFormatterTransformer {
    ...
    transform(elements, _allElements) {
        ...
        for (const element of elements) {
            ...
            const textNode = (0, MarkdownNode_1.createTextNode)(element.text.trim(), formatting);
            nodes.push(textNode);
        }
        return nodes;
    }
...
exports.InlineFormatterTransformer = InlineFormatterTransformer;
//# sourceMappingURL=InlineFormatterTransformer.js.map